  ...
  _gsScope._gsDefine(
    ...
    function (a, b, c) {
      var d,
        ...
        t = { style: {}, appendChild: s, removeChild: s },
        u = _gsScope.document || {
        ...
        w = function (a) {
          return u.createElementNS
            ? u.createElementNS("http://www.w3.org/1999/xhtml", a)
            : u.createElement(a);
        },
        x = w("div"),
        y = [],
        ...
        U = function () {
          return null != window.pageYOffset
            ...
            : null != u.scrollTop
            ? u.scrollTop
            : v.scrollTop || u.body.scrollTop || 0;
        },
        V = function () {
          return null != window.pageXOffset
            ...
            : null != u.scrollLeft
            ? u.scrollLeft
            : v.scrollLeft || u.body.scrollLeft || 0;
        },
        W = function (a, b) {
        ...
        Z = function (a, b) {
          ...
          return Math.max(
            0,
            Y(a)
              ? Math.max(v[d], f[d]) - (window["inner" + c] || v[e] || f[e])
              : a[d] - a[e]
          );
        },
        $ = function (a) {
        ...
        _ = function (a, b) {
          return (
            (a = a || window.event),
            (r.pageX = a.clientX + u.body.scrollLeft + v.scrollLeft),
            (r.pageY = a.clientY + u.body.scrollTop + v.scrollTop),
            b && (a.returnValue = !1),
            r
          );
        },
            ...
            "%" === d && -1 !== b.indexOf("border")
              ...
              : ((i.cssText =
                ...
                "%" !== d && h.appendChild
                  ...
                  : ((h = a.parentNode || u.body),
                    (i[g ? "width" : "height"] = c + d)),
                h.appendChild(x),
                (f = parseFloat(x[g ? "offsetWidth" : "offsetHeight"])),
                h.removeChild(x),
                0 !== f || e || (f = ha(a, b, c, d, !0))),
            j ? -f : f
          );
        },
        ia = function (a, b) {
          ...
          return (
            a["offset" + c] -
            (ha(a, b, parseFloat(d), (d + "").replace(ga, "")) || 0)
          );
        },
        ja = function (a, b, c) {
          var d,
        ...
        xa = [],
        ya = function (a) {
          if (!a.getBoundingClientRect || !a.parentNode || !pa)
            return {
              offsetTop: 0,
              offsetLeft: 0,
              scaleX: 1,
          ...
          for (
            ...
            (g = ja(r, pa, !0)),
              "matrix(1, 0, 0, 1, 0, 0)" !== g &&
                ...
                (xa.push(r), wa.push(r.style[pa]), (r.style[pa] = "none")),
              (r = r.parentNode);
          for (
            d = e.getBoundingClientRect(),
              g = a.getScreenCTM(),
              m = a.createSVGPoint(),
              l = m.matrixTransform(g),
              s.scaleX = Math.sqrt(g.a * g.a + g.b * g.b),
              s.scaleY = Math.sqrt(g.d * g.d + g.c * g.c),
              void 0 === h && ma(),
              s.borderBox &&
                !i &&
        ...
        za = function (a, c) {
          if (((c = c || {}), !a || a === v || !a.parentNode || a === window))
            return { x: 0, y: 0 };
          var d = ea(a),
        ...
        Aa = function (a) {
          ...
          if (
            ...
            (c = a.parentNode || v),
              c.insertBefore(x, a),
              (d.offsetParent = x.offsetParent || v),
              c.removeChild(x);
          else if (f) {
            for (
              c = a.parentNode;
        ...
        Ba = function (a, b, c, d, e) {
          ...
          if (
            ((f =
              y.isSVG && -1 !== (a.style[pa] + "").indexOf("matrix")
                ? a.style[pa]
                : B
                ? B.getPropertyValue(qa)
                : a.currentStyle
                ? a.currentStyle[pa]
                : "1,0,0,1,0,0"),
            a.getBBox &&
            ...
            if (
              ...
              y.isSVG
                ...
                ? ((s = parseInt(B.borderTopWidth, 10) || 0),
                  (t = parseInt(B.borderLeftWidth, 10) || 0),
                  (w = (f[0] - h) * t + f[2] * s),
                  (x = f[1] * t + (f[3] - h) * s),
                  (n = b.x),
                  (o = b.y),
                  ...
                  (f[3] *= o),
                  va || ((b.x += w), (b.y += x)),
                  C === u.body && i.offsetParent === v && (C = v))
                : !k &&
                  a.offsetParent &&
                  ((b.x +=
                    parseInt(ja(a.offsetParent, "borderLeftWidth"), 10) || 0),
                  (b.y +=
                    parseInt(ja(a.offsetParent, "borderTopWidth"), 10) || 0)),
              (g = z === v || z === u.body),
              (f[4] =
                Number(f[4]) +
                b.x +
              ...
              (f[5] =
                ...
                c.y -
                (g ? 0 : z.scrollTop || 0)),
              z && "fixed" === ja(a, "position", !0))
            )
              for (f[4] += V(), f[5] += U(), z = z.offsetParent; z; )
                (f[4] -= z.offsetLeft),
                  (f[5] -= z.offsetTop),
                  (z = z.offsetParent);
            else
        ...
        Ca = function (a, b) {
          ...
          for (
            var c,
              ...
              j,
              k = za(a, ra),
              l = za(a.parentNode, sa),
              m = Ba(a, k, l, !1, !b);
            (a = a.parentNode) && a.parentNode && a !== v;

          )
            (k = l),
              (l = za(a.parentNode, k === ra ? sa : ra)),
              (i = Ba(a, k, l)),
              (c = m[0]),
              (d = m[1]),
              (e = m[2]),
        ...
        Fa = function (a, b, c) {
          ...
          if (a === window)
            (g = U()),
              (e = V()),
              (f =
                e + (v.clientWidth || a.innerWidth || u.body.clientWidth || 0)),
              (h =
                g +
                ((a.innerHeight || 0) - 20 < v.clientHeight
                  ? v.clientHeight
                  : a.innerHeight || u.body.clientHeight || 0));
          else {
            ...
            (d = za(a)),
              ...
              "svg" !== a.nodeName.toLowerCase() ||
                ...
                (t = parseFloat(A.borderTopWidth) || 0),
                (e /= r.scaleX),
                (g /= r.scaleY),
                (f = e + p - (p - (p - s) / r.scaleX - x)),
                (h = g + q - (q - (q - t) / r.scaleY - y)),
                (e -= s / r.scaleX - x),
                (g -= t / r.scaleY - y),
                z &&
                  ((f += (parseFloat(A.borderRightWidth) + s) / r.scaleX),
                  (h += (t + parseFloat(A.borderBottomWidth)) / r.scaleY)));
          }
          return a === b
        ...
        Ra = function (a, b) {
          for (var c, d = a.length; --d > -1; )
            (c = a[d]),
              (c.ondragstart = c.onselectstart = b ? null : s),
            ...
            (this.calibrate = function (b) {
              ...
              (o = a.scrollTop),
                ...
                (!h ||
                  ...
                  (k.width = "100%"),
                  (k.paddingRight = s + "px"),
                  Sa && (k.paddingBottom = ja(a, "paddingBottom", !0)),
                  C && (k.zoom = "1"),
                  (d = a.clientWidth),
                  (e = a.clientHeight),
                  (q = a.scrollWidth),
        ...
        Ua = function (d, f) {
          a.call(this, d),
            (d = aa(d)),
            g || (g = q.com.greensock.plugins.ThrowPropsPlugin),
            (this.vars = f = O(f || {})),
            (this.target = d),
            (this.x = this.y = this.rotation = 0),
            (this.dragResistance = parseFloat(f.dragResistance) || 0),
            (this.edgeResistance = isNaN(f.edgeResistance)
              ? 1
              : parseFloat(f.edgeResistance) || 0),
            (this.lockAxis = f.lockAxis),
            (this.autoScroll = f.autoScroll || 0),
            (this.lockedAxis = null),
            (this.allowEventDefault = !!f.allowEventDefault);
          var h,
            i,
            j,
            k,
                ...
                for (
                  Wa = !1,
                    ...
                    M.scrollLeft =
                      null != window.pageXOffset
                        ...
                        ? v.scrollLeft
                        : u.body.scrollLeft,
                    f = Ha.pointerX - M.scrollLeft,
                    g = Ha.pointerY - M.scrollTop;
                  l && !c;
                  ...
                  (c = Y(l.parentNode)),
                    ...
                    c &&
                      ...
                      rb(Ha.pointerX + h, Ha.pointerY + j)),
                    (l = b);
              }
              if (ba) {
                var n = Ha.x,
                ...
                p > n && n > -p && (n = 0),
                  p > o && o > -p && (o = 0),
                  za
                    ? ((Ha.deltaX = n - qa.data.rotation),
                      (qa.data.rotation = Ha.rotation = n),
                      qa.setRatio(1))
                    : i
                    ? (Fa && ((Ha.deltaY = o - i.top()), i.top(o)),
                      Ea && ((Ha.deltaX = n - i.left()), i.left(n)))
                    : ya
                    ? (Fa && ((Ha.deltaY = o - qa.data.y), (qa.data.y = o)),
                      Ea && ((Ha.deltaX = n - qa.data.x), (qa.data.x = n)),
                      qa.setRatio(1))
                    : (Fa &&
                        ((Ha.deltaY = o - parseFloat(d.style.top || 0)),
                        (d.style.top = o + "px")),
                      Ea &&
                        ((Ha.deltaY = n - parseFloat(d.style.left || 0)),
                        (d.style.left = n + "px"))),
                  !t ||
                    a ||
                    ta ||
                    ((ta = !0), ka(Ha, "drag", "onDrag"), (ta = !1));
              }
              ba = !1;
            },
            eb = function (a, c) {
              ...
              d._gsTransform ||
                ...
                ya
                  ? ((Ha.y = d._gsTransform.y), (Ha.x = d._gsTransform.x))
                  : za
                  ? (Ha.x = Ha.rotation = d._gsTransform.rotation)
                  : i
                  ? ((Ha.y = i.top()), (Ha.x = i.left()))
                  : ((Ha.y = parseInt(d.style.top, 10) || 0),
                    (Ha.x = parseInt(d.style.left, 10) || 0)),
                (ea || fa || ga) &&
                  !c &&
                  (Ha.isDragging || Ha.isThrowing) &&
                  (ga &&
                    ((L.x = Ha.x),
                    (L.y = Ha.y),
                    (e = ga(L)),
                    e.x !== Ha.x && ((Ha.x = e.x), (ba = !0)),
                    e.y !== Ha.y && ((Ha.y = e.y), (ba = !0))),
                  ea &&
                    ((e = ea(Ha.x)),
                    e !== Ha.x &&
                      ((Ha.x = e), za && (Ha.rotation = e), (ba = !0))),
                  fa && ((e = fa(Ha.y)), e !== Ha.y && (Ha.y = e), (ba = !0))),
                ba && db(!0),
                a ||
                  ((Ha.deltaX = Ha.x - f),
                  (Ha.deltaY = Ha.y - g),
                  ka(Ha, "throwupdate", "onThrowUpdate"));
            },
            fb = function () {
              var a, b, c, e;
              (s = !1),
                i
                  ? (i.calibrate(),
                    (Ha.minX = x = -i.maxScrollLeft()),
                    (Ha.minY = H = -i.maxScrollTop()),
                    (Ha.maxX = w = Ha.maxY = E = 0),
                    (s = !0))
                  : f.bounds &&
                    ((a = la(f.bounds, d.parentNode)),
                    za
                      ? ((Ha.minX = x = a.left),
                        (Ha.maxX = w = a.left + a.width),
                        (Ha.minY = H = Ha.maxY = E = 0))
                      : void 0 !== f.bounds.maxX || void 0 !== f.bounds.maxY
                      ? ((a = f.bounds),
                        (Ha.minX = x = a.minX),
                        (Ha.minY = H = a.minY),
                        (Ha.maxX = w = a.maxX),
                        (Ha.maxY = E = a.maxY))
                      : ((b = la(d, d.parentNode)),
                        (Ha.minX = x = ja(d, Aa) + a.left - b.left),
                        (Ha.minY = H = ja(d, Ba) + a.top - b.top),
                        (Ha.maxX = w = x + (a.width - b.width)),
                        (Ha.maxY = E = H + (a.height - b.height))),
                    x > w && ((Ha.minX = w), (Ha.maxX = w = x), (x = Ha.minX)),
                    H > E && ((Ha.minY = E), (Ha.maxY = E = H), (H = Ha.minY)),
                    za && ((Ha.minRotation = x), (Ha.maxRotation = w)),
                    (s = !0)),
                f.liveSnap &&
                  ((c = f.liveSnap === !0 ? f.snap || {} : f.liveSnap),
                  (e = c instanceof Array || "function" == typeof c),
                  za
                    ? ((ea = nb(e ? c : c.rotation, x, w, 1)), (fa = null))
                    : c.points
                    ? (ga = ob(
                        e ? c : c.points,
                        x,
            ...
            ib = function (a, b) {
              ...
              a && g
                ? (a === !0 &&
                    ...
                    (a = {
                      resistance:
                        (f.throwResistance || f.resistance || 1e3) /
                        (za ? 10 : 1)
                    }),
                    za
                      ? (a.rotation = Pa(Ha, e ? c : c.rotation, w, x, 1, b))
                      : (Ea &&
                          (a[Aa] = Pa(
                            Ha,
                        ...
                        (c.points ||
                          ...
                          (a.radius = c.radius)))),
                  (Ha.isThrowing = !0),
                  (j = isNaN(f.overshootTolerance)
                    ? 1 === f.edgeResistance
                      ? 0
                      : 1 - Ha.edgeResistance + 0.2
                    : f.overshootTolerance),
                  (Ha.tween = h =
                    g.to(
                      i || d,
                      {
                        ...
                        onUpdateParams: f.fastMode
                          ? [Ha, "onthrowupdate", "onThrowUpdate"]
                          : c && c.radius
                          ? [!1, !0]
                          : y
                      },
                      Math.max(f.minDuration || 0, f.maxDuration || 0) || 2,
                      isNaN(f.minDuration)
                        ? 0 === j ||
            ...
            kb = function () {
              ...
              jb(!1),
                ma &&
                  ((j = Ha.pointerX * ma[0] + Ha.pointerY * ma[2] + ma[4]),
                  (k = Ha.pointerX * ma[1] + Ha.pointerY * ma[3] + ma[5])),
                ba && (rb(Ha.pointerX, Ha.pointerY), db(!0)),
                i
                  ? (fb(), (r = i.top()), (l = i.left()))
                  : (lb() ? (eb(!0, !0), fb()) : Ha.applyBounds(),
                    za
                      ? ((Z = Ha.rotationOrigin = Da(d, { x: 0, y: 0 })),
                        eb(!0, !0),
                        (l = Ha.x),
                        (r = Ha.y =
                          Math.atan2(Z.y - Ha.pointerY, Ha.pointerX - Z.x) * z))
                ...
                if (
                  ...
                  Ja[a.type]
                    ? ((ia =
                      ...
                      Ka(ia, "touchend", sb),
                      Ka(ia, "touchmove", qb),
                      Ka(ia, "touchcancel", sb),
                      Ka(u, "touchstart", Oa))
                    : ((ia = null), Ka(u, "mousemove", qb)),
                  (sa = null),
                  Ka(u, "mouseup", sb),
                  a && a.target && Ka(a.target, "mouseup", sb),
                  (ha = ab.call(Ha, a.target) && f.dragClickables === !1 && !c))
                )
                  return (
                    Ka(a.target, "change", sb),
                    ka(Ha, "pressInit", "onPressInit"),
                    ka(Ha, "press", "onPress"),
                    void Ra(Na, !0)
                  );
                if (
                  ((ra =
                    !ia ||
                    Ea === Fa ||
                    Ha.vars.allowNativeTouchScrolling === !1 ||
                    (Ha.vars.allowContextMenu &&
                      a &&
                      (a.ctrlKey || a.which > 2))
                      ? !1
                      : Ea
                  ...
                  I++,
                  Q(db),
                  (k = Ha.pointerY = a.pageY),
                  (j = Ha.pointerX = a.pageX),
                  ka(Ha, "pressInit", "onPressInit"),
                  (ra || Ha.autoScroll) && $(d.parentNode),
                  !d.parentNode ||
                    !Ha.autoScroll ||
                    i ||
                    za ||
                  ...
                  kb(),
                  Ha.tween && Ha.tween.kill(),
                  (Ha.isThrowing = !1),
                  b.killTweensOf(i || d, !0, Sa),
                  i && b.killTweensOf(d, !0, { scrollTo: 1 }),
                  (Ha.tween = Ha.lockedAxis = null),
                  (f.zIndexBoost || (!za && !i && f.zIndexBoost !== !1)) &&
                    (d.style.zIndex = Ua.zIndex++),
                  (Ha.isPressed = !0),
                  (t = !(!f.onDrag && !Ha._listeners.drag)),
                  !za && (f.cursor !== !1 || f.activeCursor))
                )
                  for (e = Na.length; --e > -1; )
                ...
                if (C) a = _(a, !0);
                  ...
                  if (
                    ...
                    ((g !== i && (g > Ga || i > Ga)) || (J && ra === sa)) &&
                      ((sa = g > i && Ea ? "x" : "y"),
                      Ha.vars.lockAxisOnTouchScroll !== !1 &&
                        ((Ha.lockedAxis = "x" === sa ? "y" : "x"),
                        "function" == typeof Ha.vars.onLockAxis &&
                          Ha.vars.onLockAxis.call(Ha, l)),
                      J && ra === sa))
                  )
                    return void sb(l);
                  Ha.allowEventDefault ||
            ...
            rb = function (a, b) {
              ...
              (Ha.pointerX = a),
                  ...
                  : (ma &&
                    ...
                    (Ha.lockAxis || Ha.lockedAxis) &&
                      ...
                      h ||
                        ...
                        h &&
                          "function" == typeof Ha.vars.onLockAxis &&
                          Ha.vars.onLockAxis.call(Ha, Ha.pointerEvent)),
                      "y" === h ? (d = 0) : "x" === h && (c = 0)),
                    (e = l + c * i),
                    (f = r + d * i)),
                (ea || fa || ga) && (Ha.x !== e || (Ha.y !== f && !za))
                  ? (ga &&
                ...
                (Ha.x !== e || (Ha.y !== f && !za)) &&
                  (za
                    ? ((Ha.endRotation = Ha.x = Ha.endX = e), (ba = !0))
                    : (Fa && ((Ha.y = Ha.endY = f), (ba = !0)),
                      Ea && ((Ha.x = Ha.endX = e), (ba = !0))),
                  !Ha.isDragging &&
                    Ha.isPressed &&
                    ((Ha.isDragging = !0), ka(Ha, "dragstart", "onDragStart")));
            },
            sb = function (a, c) {
              if (
                h &&
                ...
                (!a ||
                  ...
                  !(
                    ...
                    (a.changedTouches && !Ma(a.changedTouches, V))
                  ))
              ) {
                Ha.isPressed = !1;
                var e,
                  ...
                  m = Ha.isDragging,
                  n =
                    Ha.vars.allowContextMenu && a && (a.ctrlKey || a.which > 2),
                  o = b.delayedCall(0.001, mb);
                if (
                  (ia
                    ? (La(ia, "touchend", sb),
                      La(ia, "touchmove", qb),
                      La(ia, "touchcancel", sb),
                      La(u, "touchstart", Oa))
                    : La(u, "mousemove", qb),
                  La(u, "mouseup", sb),
                  a && a.target && La(a.target, "mouseup", sb),
                  (ba = !1),
                  ha && !n)
                )
                  return (
                    a && (La(a.target, "change", sb), (Ha.pointerEvent = l)),
                    Ra(Na, !1),
                    ka(Ha, "release", "onRelease"),
                    ka(Ha, "click", "onClick"),
                    void (ha = !1)
                  );
                if ((R(db), !za))
                ...
                return (
                  n && l
                    ? (l.preventDefault(),
                      ...
                      ka(Ha, "release", "onRelease"))
                    : l && !m
                    ? (na && (f.snap || f.bounds) && ib(f.throwProps),
                      ka(Ha, "release", "onRelease"),
                      (J && "touchmove" === l.type) ||
                        -1 !== l.type.indexOf("cancel") ||
                        (ka(Ha, "click", "onClick"),
                        B() - bb < 300 &&
                          ka(Ha, "doubleclick", "onDoubleClick"),
                            ...
                            (j.click
                              ...
                              : u.createEvent &&
                                ...
                                i.initMouseEvent(
                                  ...
                                  window,
                                  1,
                                  Ha.pointerEvent.screenX,
                                  Ha.pointerEvent.screenY,
                                  Ha.pointerX,
                                  Ha.pointerY,
                                  !1,
                                  !1,
                    ...
                    : (ib(f.throwProps),
                      C ||
                        Ha.allowEventDefault ||
                        !l ||
                        (f.dragClickables === !1 && ab.call(Ha, l.target)) ||
                        !m ||
                        (ra && (!sa || ra !== sa)) ||
                        l.cancelable === !1 ||
                        (l.preventDefault(),
                        l.preventManipulation && l.preventManipulation()),
                      ka(Ha, "release", "onRelease")),
                  lb() && o.duration(Ha.tween.duration()),
                  m && ka(Ha, "dragend", "onDragEnd"),
                  !0
                );
              }
            },
            ...
            ub = function (a) {
              ...
              return (
                f &&
                  (e || (d && Ha.vars.suppressClickOnDrag !== !1)) &&
                  a.stopImmediatePropagation(),
                !c ||
                (Ha.pointerEvent && Ha.pointerEvent.defaultPrevented) ||
                (e && i === h)
                  ? void (
                      (Ha.isPressed || d || c) &&
                      (f
          ...
          (da = Ua.get(this.target)),
            da && da.kill(),
            (this.startDrag = function (a, b) {
              var c, e, f, g;
              pb(a || Ha.pointerEvent, !0),
                b &&
                  !Ha.hitTest(a || Ha.pointerEvent) &&
                  ((c = Ya(a || Ha.pointerEvent)),
                  (e = Ya(d)),
                  (f = vb({
                    x: c.left + c.width / 2,
                    y: c.top + c.height / 2
              ...
              var c,
                ...
                j =
                  "velocity" === a && g
                    ...
                    : "element";
              return (
                "element" === j && ((h = Ya(Ha.target)), (i = Ya(a))),
                (c =
                  "start" === j
                    ? Ha.x - l
                    : "velocity" === j
                    ? g.getVelocity(this.target, Aa)
                  ...
                  : ((b = b || 2),
                    (d =
                      "start" === j
                        ? Ha.y - r
                        : "velocity" === j
                        ? g.getVelocity(this.target, Ba)
                        : h.top + h.height / 2 - (i.top + i.height / 2)),
                    (e = Math.abs(c / d)),
                    (f = 1 / b > e ? "" : 0 > c ? "left" : "right"),
                    b > e &&
                      ("" !== f && (f += "-"), (f += 0 > d ? "up" : "down")),
                    f)
              );
              ...
              if ((eb(!0), fb(), s)) {
                if (
                  ...
                  (Ha.x !== b || Ha.y !== c) &&
                    ((e = !0),
                    (Ha.x = Ha.endX = b),
                    za ? (Ha.endRotation = b) : (Ha.y = Ha.endY = c),
                    (ba = !0),
                    db(!0),
                    Ha.autoScroll && !Ha.isDragging))
                )
                  for (
                    $(d.parentNode),
                      g = d,
            ...
            (this.update = function (a, b, c) {
              ...
              return (
                jb(!b),
                a ? Ha.applyBounds() : (ba && c && db(!0), eb(!0)),
                b && (rb(Ha.pointerX, Ha.pointerY), ba && db(!0)),
                Ha.isPressed &&
                  !b &&
                  ((Ea && Math.abs(e - Ha.x) > 0.01) ||
                    (Fa && Math.abs(f - Ha.y) > 0.01 && !za)) &&
                  kb(),
                Ha.autoScroll &&
                  ($(d.parentNode), (Wa = Ha.isDragging), db(!0)),
                Ha.autoScroll && (X(d, tb), W(d, tb)),
                Ha
              );
            }),
              ...
              if ("soft" !== a) {
                for (j = Na.length; --j > -1; )
                  (k = Na[j]),
                    ...
                    this.vars.allowContextMenu || Ka(k, "contextmenu", cb);
                Ra(Na, !1);
              }
              return (
                W(d, tb),
                ...
                g &&
                  "soft" !== a &&
                  g.track(i || d, ya ? "x,y" : za ? "rotation" : "top,left"),
                i && i.enable(),
                (d._gsDragID = e = "d" + G++),
                (F[e] = this),
            ...
            (this.disable = function (a) {
              ...
              return (
                ...
                g &&
                  "soft" !== a &&
                  g.untrack(i || d, ya ? "x,y" : za ? "rotation" : "top,left"),
                i && i.disable(),
                R(db),
                (Ha.isDragging = Ha.isPressed = ha = !1),
                e && ka(Ha, "dragend", "onDragEnd"),
                Ha
              );
            }),
            ...
            (this.kill = function () {
              return (
                ...
                b.killTweensOf(i || d, !0, Sa),
                Ha.disable(),
                b.set(Na, { clearProps: "userSelect" }),
            ...
            -1 !== xa.indexOf("scroll") &&
              ...
              (d.style.overflowY = Fa && !Ia ? "auto" : "hidden"),
              (d.style.overflowX = Ea && !Ia ? "auto" : "hidden"),
              (d = i.content)),
            f.force3D !== !1 && b.set(d, { force3D: !0 }),
            za ? (Sa.rotation = 1) : (Ea && (Sa[Aa] = 1), Fa && (Sa[Ba] = 1)),
            za
      ...
      (Va.constructor = Ua),
        (Va.pointerX =
          ...
          Va.deltaY =
            0),
        (Va.isDragging = Va.isPressed = !1),
        (Ua.version = "0.17.1"),
        (Ua.zIndex = 1e3),
        Ka(u, "touchcancel", function () {}),
        ...
        (Ua.create = function (a, c) {
          "string" == typeof a && (a = b.selector(a));
          for (
            var d = a && 0 !== a.length ? (Ga(a) ? Ha(a) : [a]) : [],
              e = d.length;
            --e > -1;
        ...
        Ya = function (a, b) {
          if (a === window)
            return (
              (Wa.left = Wa.top = 0),
              (Wa.width = Wa.right =
                v.clientWidth || a.innerWidth || u.body.clientWidth || 0),
              (Wa.height = Wa.bottom =
                (a.innerHeight || 0) - 20 < v.clientHeight
                  ? v.clientHeight
                  : a.innerHeight || u.body.clientHeight || 0),
